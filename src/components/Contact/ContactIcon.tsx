...
import { ContactIconInterface } from './ContactSection';

export default function ContactIcon({ icon }: { icon: ContactIconInterface }): JSX.Element {
  ...
  return (
    <ImageStyle href={icon.href} target="_blank">
      <Image height={25} width={25} alt={icon.name} src={`/resources/${icon.icon}`} />
    </ImageStyle>
