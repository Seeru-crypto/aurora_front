...
import { MdOutlineDone, MdUpdate,  MdOutlineLocationOn} from 'react-icons/md'
...
export default function SectionCounter (){
    ...
    return (
        <SectionCounterStyle>
                <div className="card">
                    <i className={"icon"}><MdOutlineDone /></i>
                    <p>Number of projects</p>
                    <h3>{numberOfProjects}</h3>
                </div>
                <div className="card">
                    <i className="icon"><BsCalendarCheck /></i>
                    <p>Coding since</p>
                    <h3>2016</h3>
                </div>
                <div className="card">
                    <i className="icon"><MdUpdate /></i>
